                ...
                <div id="accessories-tab" class="as-accessories-details">
                    <div class="as-accessories" id="as-accessories">
                        ...
                        <div class="as-accessories-results  as-search-desktop">
                            <div class="width:60%;" style="padding-top:10px;padding-bottom:10px;">
                            <h4>external_reference</h4><?=$_GET['external_reference']?><br />
                            <h4>collection_id</h4><?=$_GET['collection_id']?><br />
                            <h4>processing_mode</h4><?=$_GET['processing_mode']?><br />
                            <h4>preference_id</h4><?=$_GET['preference_id']?><br />
                            <h4>merchant_order_id</h4><?=$_GET['merchant_order_id']?><br />
                            <h4>payment_type</h4><?=$_GET['payment_type']?><br />
                            <h4>collection_status</h4><?=$_GET['collection_status']?><br />
